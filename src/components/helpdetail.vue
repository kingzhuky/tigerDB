<template>
  <div class="outside">
    <div v-show="searchshow">
      ...
      <p>Through the correlation analysis of the gene in Pan-cancer, you can know which Immune Signature of the gene is more related, and you can see the specific correlation scatter diagram by clicking the cell of table.</p>
      <div align="center">
    ...
    <div v-show="signatureshow">
      ...
      <p>Use the Overview table of Immune Signature to show the degree of correlation between each Immune Signature and immune response (AUC is obtained from the analysis of all immune response data collected).</p>
      <div align="center">
        <img class="helpimg-detail" alt="signature1_1" v-lazy="signature1_1" />
      </div>
      <p>Click on the detail button in the table, and TIGER will display the related information of changing Immune Signature, as well as the Differential Signature Score Analysis in immune response data and Tumor/Normal expression data.</p>
      <div align="center">
         <img class="helpimg-detail" alt="signature1_2" v-lazy="signature1_2" />
      </div>
      
      <h3 class="sub">Custom Analysis</h3>
      <p>Through Immune Signature analysis of the expression matrix and sample information provided by the user, the correlation between the sample and the Immune Signature is shown to be related to the immune response of the tumor.</p>
      <div align="center">
    ...
    <div v-show="singcellshow">
      ...
      <div align="center">
        ...
        <img class="helpimg-detail" alt="singcelln4" v-lazy="singcelln4" />
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      singcelln4: require("../assets/singcell-n4.png"),
